...
const SYSTEM_PROMPT = `You are the AI Guardian for Manus Brain Dashboard — Multi-AI model router and knowledge hub.
You help users with:
- Routing queries to Claude, Kimi, DeepSeek or Manus
