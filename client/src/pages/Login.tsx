    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground font-mono tracking-wide">MANUS BRAIN</h1>
            <p className="text-muted-foreground text-sm mt-1">AI Knowledge System — Autoryzacja wymagana</p>
          </div>
        </div>
